"""
This file is the implementation of Random Search with Random Forest Classifier model
...
def randomForestClassifierGS(size_split):
    ...
    for score in scores:
        ...
        Random = RandomizedSearchCV(RandomForestClassifier(), rf_params, cv=5, scoring=score, n_jobs=2)
